...
import { ButtonBlockFragment } from '../ButtonBlock/fragments';
...
export const ButtonsListBlockFragment = graphql(
  /* GraphQL */ `
    fragment ButtonsListBlockFragment on ButtonsListBlockRecord {
      items {
        id
        label
        ...ButtonBlockFragment
