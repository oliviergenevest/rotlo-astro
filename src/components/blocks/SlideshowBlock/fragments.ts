...
import { ImageTextBlockFragment } from '../ImageTextBlock/fragments';
...
export const SlideshowBlockFragment = graphql(
  /* GraphQL */ `
    fragment SlideshowBlockFragment on SlideshowBlockRecord {
      items {
